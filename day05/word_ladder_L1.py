...
def load_word_list(wordlist_3Letter: str) -> set:
    """
    ...
    words = set()
    try:
        with open(wordlist_3Letter, "r") as file:
            for line in file:
        ...
        print(f"Error: Cannot find {wordlist_3Letter}. Make sure it exists.")
        return set()
...
def main():
    ...
    word_list = load_word_list("wordlist_3Letter.txt")
